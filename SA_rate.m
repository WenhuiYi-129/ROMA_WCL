function SA_SE = SA_rate(p_max,noise,Nh,Nv,Mh,Mv,lambda,theta_r, phi_r, theta_t,phi_t, path_loss,L,location_u,R_s2, R_r2, M, M2,N, N2,K,cap_temp,cap_before,epsil,alpha,beta,delta)
