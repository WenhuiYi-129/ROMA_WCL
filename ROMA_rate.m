function ROMA_SE = ROMA_rate(p_max,d,epsil,cap_temp, cap_before,iter,Nter, n_A, noise,...
    location_u,Mh,Mv,Nh,Nv,K,L,Z_S, R_s, R_r, theta_r, phi_r, ...
    theta_t,phi_t, alpha,beta,path_loss, lambda, A,Z_R,Z_alpha,Z_beta)
M=Mh*Mv;
N=Nh*Nv;
...
[beta] = update_beta(p_max,noise,location_u,Mh,Mv,Nh,Nv,K,L,Z_beta, R_s, R_r, theta_r, phi_r, theta_t,phi_t,alpha,beta,path_loss, lambda, A);
[Z_beta ] = update_z(Z_beta , beta , d);
