function [beta] = update_beta(noise,location_u,Mh,Mv,Nh,Nv,K,L,R_s, R_r, theta_r, phi_r, theta_t,phi_t,alpha,beta,path_loss, lambda, A)
...
beta_opt = fmincon(@(beta) objective(noise,location_u,Mh,Mv,Nh,Nv,K,L,R_s, R_r, theta_r, phi_r, theta_t,phi_t,alpha,beta,path_loss, lambda, rho), beta, [], [], [], [], ...
                               lb, ub, [], opt);
beta     = beta_opt;
